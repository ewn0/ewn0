...
█  Windows Security | Active Directory | Vulnerability Mgmt  █
█                                                             █
███████████████████████████████████████████████████████████████
```
...
**Domains** : Windows Security | Active Directory | LDAP | CVE Management

**Tools** : Git | PowerShell DSC | Excel automation
...
```
Projects      : 2+ en production
Languages     : Python, PowerShell
Focus Area    : Defensive Security & Automation
Env           : Windows | Linux (occasional)
```
...
- **Discord** : Fallx (fitness & security communities)
- **GitHub** : [@ewn0](https://github.com/ewn0)

**Open to** : Collaborations, code reviews, security discussions
